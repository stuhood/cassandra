 ...
 * rows should use the RowHeader structure (which does not hold metadata) instead.
 */
public class NestedRowHeader extends RowHeader
{
    ...
    NestedRowHeader(long position, long markedForDeleteAt, int localDeletionTime, ByteBuffer min, ByteBuffer max)
    {
        super(position);
