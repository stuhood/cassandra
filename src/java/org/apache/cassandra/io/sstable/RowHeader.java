 ...
 * using the NestedRowHeader subclass, which contains row metadata and thresholds. This
...
public class RowHeader
{
    ...
    /** @return True if this RowHeader contains the metadata and min/max values for this row. */
    ...
    {
        return "RowHeader(position=" +position + ",metadata=" + isMetadataSet() + ")";
    }
