...
{   
    ...
    {
        testUpdateColumnFamilyIndex("KeysIndexedCf", org.apache.cassandra.db.migration.avro.IndexType.KEYS);
    }
    ...
    {
        testUpdateColumnFamilyIndex("KeysBitmapIndexedCf", org.apache.cassandra.db.migration.avro.IndexType.KEYS_BITMAP);
    }
    */

    private void testUpdateColumnFamilyIndex(final String cf, org.apache.cassandra.db.migration.avro.IndexType type) throws Exception
    {
        ...
        // 'just' add an index
        org.apache.cassandra.db.migration.avro.ColumnDef index = new org.apache.cassandra.db.migration.avro.ColumnDef();
        index.name = Util.bytes(indexname);
        index.validation_class = UTF8Type.class.getCanonicalName();
        index.index_type = type;
        index.index_name = indexname;

        org.apache.cassandra.db.migration.avro.CfDef upCf = baseCf.deflate();
