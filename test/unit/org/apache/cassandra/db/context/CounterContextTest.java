...
public class CounterContextTest
{
    ...
    {
        SlabAllocator allocator = new SlabAllocator(direct, 1024);
    ...
    public void testMergeOldShards()
    {
        ...
        runMergeOldShards(bumpedSlab(false));
        runMergeOldShards(bumpedSlab(true));
    }
    ...
    public void testRemoveOldShards()
    {
        ...
        runRemoveOldShards(bumpedSlab(false));
        runRemoveOldShards(bumpedSlab(true));
    }
