...
public class LongCompactionSpeedTest extends CleanupHelper
{
    ...
    protected void testCompaction(int sstableCount, int rowsPerSSTable, int colsPerRow) throws Exception
    {
        ...
        CompactionManager.instance.doCompaction(store, sstables, false, (int) (System.currentTimeMillis() / 1000) - DatabaseDescriptor.getCFMetaData(TABLE1, "Standard1").getGcGraceSeconds());
