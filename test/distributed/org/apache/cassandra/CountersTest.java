...
{
    @Test
    public void testOneNodeWrite() throws Exception
    {
        ...
        for (InetAddress host : hosts)
        {
            ...
            assertEquals(1, getCounter(client, key, "Standard1", "c1", ConsistencyLevel.ONE).value);
            assertEquals(2, getCounter(client, key, "Standard1", "c2", ConsistencyLevel.ONE).value);
        }
    }
    ...
    protected CounterColumn getCounter(Cassandra.Client client, ByteBuffer key, String cf, String col, ConsistencyLevel cl)
        throws InvalidRequestException, UnavailableException, TimedOutException, TException, NotFoundException
    {
        ...
        return client.get_counter(key, cpath, cl).column;
    }
}
